					...
					<div class="col-md-9 py-5">
						<div class="row">
							<div class="col-md-4 mb-md-0 mb-4">
								<h2 class="footer-heading"><img src="<?php echo get_template_directory_uri();?>/images/logo.png"></h2>
								<p>A dedicated group of social workers and labour movement activists, imbued with the spirit of service to the cause of mill workers, other industrial and hitherto neglected economically weaker sections of society started MACO Bank.</p>
